...
export const ModalProvider: React.FC<{ children: ReactNode }> = ({
  ...
  return (
    <ModalContext.Provider value={{ isOpen, content, openModal, closeModal }}>
      ...
      {isOpen && (
        <div
          className={clsx(`fixed top-0 left-0 w-full h-full z-30 flex justify-center items-center transition-transform bg-customMarsala-accentLight`, showAnimation ? classNameAnimationIn : classNameAnimationOut, classNameBackdrop)}
        >
          <div
